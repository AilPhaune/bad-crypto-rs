...
pub trait Field<T: Debug, NZ: Debug>: Ring<T> {
...
#[derive(Debug)]
pub struct Fraction<T: Debug, NZ: Debug, U: Debug, F: FiniteField<T, NZ, U>> {
    _field: PhantomData<(T, NZ, U, F)>,
    num: T,
    den: T,
}

impl<T: Debug, NZ: Debug, U: Debug, F: FiniteField<T, NZ, U>> Fraction<T, NZ, U, F> {
    pub fn new(num: T, den: T) -> Fraction<T, NZ, U, F> {
        Fraction {
            _field: PhantomData,
            num,
            den,
    ...
    pub fn mul(&self, other: &Fraction<T, NZ, U, F>, field: &F) -> Fraction<T, NZ, U, F> {
        Fraction::new(
    ...
    pub fn div(&self, other: &Fraction<T, NZ, U, F>, field: &F) -> Fraction<T, NZ, U, F> {
        Fraction::new(
    ...
    pub fn inv(&self, field: &F) -> Fraction<T, NZ, U, F> {
    ...
    pub fn add(&self, other: &Fraction<T, NZ, U, F>, field: &F) -> Fraction<T, NZ, U, F> {
    ...
    pub fn neg(&self, field: &F) -> Fraction<T, NZ, U, F> {
    ...
    pub fn sub(&self, other: &Fraction<T, NZ, U, F>, field: &F) -> Fraction<T, NZ, U, F> {
        // a/b - c/d = ad/bd - bc/ab = (ad - bc)/(bd)
        let ad = field.mul(&self.num, &other.den);
        let bc = field.mul(&self.den, &other.num);
        let bd = field.mul(&self.den, &other.den);
